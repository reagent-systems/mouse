...
if bad == 0 && !ours.isEmpty { print("AGENT EXTENSION MATCH — a subclass's createConnection decides where the request goes") }
else { print("AGENT EXTENSION MISMATCH — \(bad) of \(a.count)")
